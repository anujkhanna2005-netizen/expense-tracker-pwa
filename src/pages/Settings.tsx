...
const Settings: React.FC = () => {
  ...
  const handleExportCSV = () => {
    ...
    const incomeRows = incomes.map(inc => [
      ...
      inc.source,
      inc.amount.toString(),
      inc.isRecurring ? (inc.recurringFrequency || 'monthly') : 'Once',
  ...
  const handleImportJSON = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        setImportDataPending(parsed);
        setShowImportConfirm(true);
      } catch (err) {
        toast('Failed to parse file. Ensure it is a valid JSON file.', 'error');
      }
    };
  ...
  return (
    <div className={styles.settingsContainer}>
      ...
      <PreferencesSection
        ...
        setIsManageCatsOpen={setIsManageCatsOpen}
